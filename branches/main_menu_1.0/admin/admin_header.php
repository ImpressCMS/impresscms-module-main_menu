...
include_once(MAIN_MENU_ROOT_PATH . 'include/requirements.php');
...
*/
if (is_object($icmsModule) && $icmsModule->dirname() == MAIN_MENU_DIRNAME) {
	// We are in the module
	if (defined('XOOPS_CPFUNC_LOADED')) {
		// We are in the admin side of the module
		if (!$icmsModule->getDBVersion()) {
			redirect_header(ICMS_URL . '/modules/system/admin.php?fct=modulesadmin&op=update&module=' . MAIN_MENU_DIRNAME, 4, _AM_MAIN_MENU_FIRST_USE);
			exit;
		}
	}
}
