 ...
 */
/*function main_menu_db_upgrade_1() {
}
function main_menu_db_upgrade_2() {
}*/

function icms_module_update_main_menu($module) {
	/**
...
function icms_module_install_main_menu($module) {
